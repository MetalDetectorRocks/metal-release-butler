...
class DevelopmentDbInitializer implements ApplicationRunner {
  ...
  void run(ApplicationArguments args) throws Exception {
    ReleaseEntity alcest = ReleaseEntity.builder()
            ...
            .releaseDate(LocalDate.of(2019, 9, 25).atStartOfDay(ZoneId.of("UTC")).toOffsetDateTime())
    ...
    ReleaseEntity cradleOfFilth = ReleaseEntity.builder()
            ...
            .releaseDate(LocalDate.of(2019, 9, 1).atStartOfDay(ZoneId.of("UTC")).toOffsetDateTime())
    ...
    ReleaseEntity voland = ReleaseEntity.builder()
            .artist("平衡世界的意志")
            .albumTitle("Bоланд")
            .releaseDate(LocalDate.of(2019, 9, 23).atStartOfDay(ZoneId.of("UTC")).toOffsetDateTime())
    ...
    ReleaseEntity grond = ReleaseEntity.builder()
            ...
            .releaseDate(LocalDate.of(2019, 9, 30).atStartOfDay(ZoneId.of("UTC")).toOffsetDateTime())
            .genre("Death Metal")
